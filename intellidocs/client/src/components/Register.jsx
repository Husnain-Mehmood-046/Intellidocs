/**
 * Register component (Redesigned - Pass 2).
 *
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "var(--space-5)" }}>
            ...
            {fieldErrors.password ? (
              ...
              <p id="password-hint" style={{ margin: "var(--space-1) 0 0", fontSize: "var(--text-xs)", color: "var(--ink-muted)" }}>
          ...
          <div style={{ marginBottom: "var(--space-6)" }}>
            ...
            <input
              ...
              style={{
                ...
                color: "var(--ink)",
                background: "var(--paper-elevated)",
                border: `1px solid ${fieldErrors.confirmPassword ? "var(--trust-low)" : "var(--border)"}`,
                borderRadius: "var(--radius-md)",
                boxSizing: "border-box",
                transition: "border-color var(--transition-fast), box-shadow var(--transition-fast)",
              }}
            ...
            {fieldErrors.confirmPassword && (
              <p id="confirm-error" style={{ margin: "var(--space-1) 0 0", fontSize: "var(--text-xs)", color: "var(--trust-low)" }}>
                {fieldErrors.confirmPassword}
              </p>
            )}
          </div>
